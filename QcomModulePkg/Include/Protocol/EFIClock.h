...
/** @ingroup efi_test_clock_logClockState
  ...
  Read BDSClockLogState in EFI_VARIABLE_NON_VOLATILE.
  Based on the current BDSClockLogState setting, whether or not
...
/** @ingroup efi_test_clock_DumplogClockState
  ...
  Read BDSClockLogState in BDS menu.
  Based on the current BDSClockLogState setting, whether or not
  the clocks states will be dumpped
...
/** @ingroup efi_clock_protocol
  ...
  @inputprotoparams{clock_proto_params.tex}
*/
typedef struct _EFI_CLOCK_PROTOCOL {
   UINT64                           Version;
